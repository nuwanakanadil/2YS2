...
export default function UserLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      ...
      //assign direction according to the role
            ...
            <form className="space-y-16" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="text-sm">
                  <a href="/user/ForgotPassword" className="text-white hover:underline font-medium">
              ...
              <div className="mt-12">
                ...
                <p className="text-sm mt-6 text-center text-white">
                  ...
                  <a href="/user/signup" className="text-white font-medium hover:underline ml-1">
                    Register here
                  </a>
                </p>
              </div>
