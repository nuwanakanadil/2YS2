            ...
            <form class="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  class="w-full text-sm text-black-900 border border-slate-300 pl-4 pr-4 py-3 rounded-lg outline-blue-600"
              ...
              <div class="!mt-12">
                ...
                <p class="text-sm !mt-6 text-center text-white-600">Already have an account? <a href="/manager/ManagerLogin" class="text-white-600 font-medium hover:underline ml-1 whitespace-nowrap">Login here</a></p>
              </div>
            </form>
          </div>
